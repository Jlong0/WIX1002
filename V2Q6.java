...
public class V2Q6 {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            try {
                System.out.println("Enter the amount of test case (1-10): ");
                testCase = sc.nextInt();
    ...
    public static String removeNonInitials(String name){
        ...
        for (int x = 0; x < delimiter.length; x++){
            name = name.replaceAll(delimiter[x], " ");
        }
       
        name = name.replaceAll(" bin ", " ");
        name = name.replaceAll(" binti ", " ");
        name = name.replaceAll(" a/l ", " ");
        name = name.replaceAll(" a/p ", " ");
        name = name.replaceAll(" al ", " ");
        name = name.replaceAll(" ap ", " ");
